...
export const sendVerificationEmail = async (email, code, name) => {
  ...
  if (client) {
    try {
      ...
      sendSmtpEmail.sender = { name: 'NYU Mealswipe', email: 'noreply@nyumealswipe.com' };
      sendSmtpEmail.to = [{ email }];
      sendSmtpEmail.subject = 'Verify your NYU Mealswipe account';
...
export const sendPasswordResetEmail = async (email, code, name) => {
  ...
  if (client) {
    try {
      ...
      sendSmtpEmail.sender = { name: 'NYU Mealswipe', email: 'noreply@nyumealswipe.com' };
      sendSmtpEmail.to = [{ email }];
      sendSmtpEmail.subject = 'Reset your NYU Mealswipe password';
      sendSmtpEmail.htmlContent = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
